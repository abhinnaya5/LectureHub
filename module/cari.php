...
<!-- Courses Start -->
    <div class="container-fluid py-5">
        <div class="container py-5">
			...
			<?php
			$word=$_GET['word'];
      $query = mysqli_query($koneksi, "SELECT * FROM tbvideo,tbuser,tbkategori,tbjenis where tbvideo.id_user=tbuser.id_user and tbvideo.id_kategori=tbkategori.id_kategori and tbvideo.id_jenis=tbjenis.id_jenis and tbvideo.judul like '%$word%' order by tbvideo.id_video desc") or die (mysqli_error());
