...
<head>
  ...
  <title>ADMINISTRATOR LECTUREHUB</title>
...
<body class="hold-transition login-page" style="background-color: #202c45;">
<div class="login-box">
  <div class="login-logo">
    <a href="index2.html"><b style="color: #ffffff;">ADMINISTRATOR LECTUREHUB</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="" method="post">
        ...
        <div class="row">
		  ...
		  /.col -->
          <div class="col-4">
            <button type="submit" name="Simpan" class="btn btn-primary btn-block">Log In</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
