...
<div class="card">
  ...
  $query = mysqli_query($koneksi, "SELECT * FROM tbloker,tbperusahaan where tbloker.id_perusahaan=tbperusahaan.id_perusahaan order by tbloker.id_loker asc") or die (mysqli_error());
...
";
  ...
  <td align="right"><?php  $gaji=$r['gaji']; echo "Rp.".number_format($gaji,0,".","."); ?> </td>
  <td><?php echo tgl_indo($r['tgl_akhir']); ?></td>  
  <td align="center">
   <a href="<?php echo "$_SERVER[PHP_SELF]?module=loker&stt=edit&kd=view&id=".$r['id_loker'] ?>"><i class="fa fa-search"></i></a> 
