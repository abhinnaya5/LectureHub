...
<div class="card">
              ...
              <div class="card-body">
                 <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
  $query = mysqli_query($koneksi, "SELECT * FROM tbuser where level='Admin' order by id_user asc") or die (mysqli_error());
...
if(isset($_POST['Simpan'])){
  ...
  $querytambah = mysqli_query($koneksi, "INSERT INTO tbuser VALUES('', '$nama', '$username', '$email', '$password', '$password', '$gambar', 'Admin')") or die(mysqli_error());
  if($querytambah) {
